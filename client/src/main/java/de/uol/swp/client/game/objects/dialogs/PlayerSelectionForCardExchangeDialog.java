...
public class PlayerSelectionForCardExchangeDialog extends AbstractDialog<String> {

    public static final String HEADER = "Spieler auswählen";
    private final List<IPlayerDTO> players;

    public PlayerSelectionForCardExchangeDialog(List<IPlayerDTO> players) {
        super();
    ...
    private void setContent() {
        ...
        Label label = new Label("Wähle einen Spieler aus, mit dem du Karten tauschen möchtest: ");
        HBox playerBox = new HBox();
        playerBox.getStyleClass()
                 .add(HBOX_STYLE);
        for (IPlayerDTO player : players) {
            PlayerButton playerButton = new PlayerButton(
                    player.getUsername(), event -> {
