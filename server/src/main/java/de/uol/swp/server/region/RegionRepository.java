...
public class RegionRepository {
    ...
    private void createAllRegions() {
        ...
        regions.add(new Region(1,
                cityRepository.getCitiesByNames(CityName.A_CORUNA,
        ...
        regions.add(new Region(3,
                cityRepository.getCitiesByNames(CityName.VIGO,
                        CityName.BRAGA,
                        CityName.SALAMANCA,
                        CityName.LEON,
                        CityName.OURENSE
        ...
        regions.add(new Region(5,
                cityRepository.getCitiesByNames(CityName.BRAGA,
                        CityName.PORTO,
                        CityName.COIMBRA,
                        CityName.CACERES,
                        CityName.SALAMANCA
        ...
        regions.add(new Region(7,
                cityRepository.getCitiesByNames(CityName.COIMBRA,
                        CityName.LISBOA,
                        CityName.EVORA,
                        CityName.BADAJOZ,
                        CityName.CACERES
        ...
        regions.add(new Region(9,
                cityRepository.getCitiesByNames(CityName.EVORA,
                        CityName.SEVILLA,
                        CityName.CORDOBA,
                        CityName.BADAJOZ,
                        CityName.HUELVA
        ...
        regions.add(new Region(16,
                cityRepository.getCitiesByNames(CityName.CIUDAD_REAL,
                        CityName.CORDOBA,
                        CityName.JAEN,
                        CityName.ALBACETE
                )
        ...
        regions.add(new Region(17,
                cityRepository.getCitiesByNames(CityName.ALBACETE,
                        CityName.CARTAGENA,
                        CityName.ALICANTE,
                        CityName.VALENCIA
                )
        ...
        regions.add(new Region(18,
                cityRepository.getCitiesByNames(CityName.MADRID,
                        CityName.CIUDAD_REAL,
                        CityName.ALBACETE,
                        CityName.CUENCA
                )
        ));
        regions.add(new Region(19,
        ...
        regions.add(new Region(21,
                cityRepository.getCitiesByNames(CityName.VALENCIA,
        ...
        regions.add(new Region(22,
                cityRepository.getCitiesByNames(CityName.ZARAGOZA,
                        CityName.TERUEL,
                        CityName.TARRAGONA,
                        CityName.BARCELONA
                )
        ));
        regions.add(new Region(23,
                cityRepository.getCitiesByNames(CityName.HUESCA,
                        CityName.ZARAGOZA,
                        CityName.BARCELONA,
                        CityName.GIRONA,
        ...
        regions.add(new Region(24,
                cityRepository.getCitiesByNames(CityName.VICTORIA_GASTEIZ,
                        CityName.ZARAGOZA,
                        CityName.HUESCA,
                        CityName.PAMPLONA
                )
        ));
        regions.add(new Region(25,
                cityRepository.getCitiesByNames(CityName.BILBAO_BILBO,
                        CityName.VICTORIA_GASTEIZ,
                        CityName.PAMPLONA,
                        CityName.SAN_SEBASTIAN_DONOSTIA
                )
        ));
        regions.add(new Region(26, cityRepository.getCitiesByNames(CityName.SANTANDER,
                CityName.VALLADOLID,
                CityName.BURGOS,
                CityName.VICTORIA_GASTEIZ,
                CityName.BILBAO_BILBO
        )));
        regions.add(new Region(27,
                cityRepository.getCitiesByNames(CityName.GIJON,
                        CityName.LEON,
                        CityName.SALAMANCA,
                        CityName.VALLADOLID,
                        CityName.SANTANDER
        ...
        regions.add(new Region(29,
                cityRepository.getCitiesByNames(CityName.VALLADOLID,
                        CityName.MADRID,
                        CityName.ZARAGOZA,
                        CityName.SORIA,
                        CityName.BURGOS
        ...
        regions.add(new Region(30,
                cityRepository.getCitiesByNames(CityName.BURGOS,
                        CityName.SORIA,
                        CityName.ZARAGOZA,
                        CityName.VICTORIA_GASTEIZ
                )
        ...
        regions.add(new Region(34,
                cityRepository.getCitiesByNames(CityName.CACERES,
                        CityName.BADAJOZ,
                        CityName.CIUDAD_REAL,
                        CityName.TOLEDO
                )
