...
public class GameController
{
    ...
    public void nextTurn() throws InterruptedException
    {
        ...
        System.out.println(currentPlayer.getUser().getUsername() + " ist nun am Zug!");
    ...
    {
        System.out.println(currentPlayer.getUser().getUsername() + " hat seinen Zug beendet.");
    ...
    public void receiveActionMessage(User user, Action action) {
        ...
        if (players.get(currentPlayerIndex).getUser().equals(user)) {
